...
bool initFont(const(char)[] customPath = null, int size = FONT_SIZE)
{
    ...
    if (customPath.length > 0)
    {
        ...
        // Ensure null-terminated for TTF_OpenFont.
        const(char)* pathPtr;
        if (memchr(customPath.ptr, 0, customPath.length) !is null)
            pathPtr = customPath.ptr;
        else
        {
...
// "The content of the atlas_texture array is a raw monochromatic bitmap,
// 8bits per pixel. See #9 for how the original image was generated;
// imagemagick was used to convert the resultant image to a raw greyscale
// bitmap, xxd was used to generate the C array literal."
//
...
// Index used for font and icon sizes
immutable mu_Rect[] atlas = [
